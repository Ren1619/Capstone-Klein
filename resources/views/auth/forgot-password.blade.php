...
<head>
    ...
    <title>Forgot Password - Pelaez Derm Clinic</title>
            ...
            <div class="px-6 sm:px-12 lg:px-24 py-8 flex flex-col justify-center items-center gap-3.5">
                <div class="w-full flex justify-center items-start">
                    <div class="text-center">
                        <span class="text-[#FF006E] text-3xl sm:text-4xl lg:text-5xl font-bold">Forgot </span>
                ...
                <div class="w-full max-w-md flex flex-col justify-start items-start gap-3.5">
                    ...
                    <div class="w-full text-center">
                        <a href="{{ route('login') }}" class="text-black text-sm font-light hover:text-[#FF006E]">
                            Back to Login
                        </a>
                    </div>
                </div>
